...
/* 16 */   public static final String ID = KoishiMod.makeID(Heartbroken.class.getSimpleName());
/* 17 */   public static final String IMG = KoishiMod.makeCardPath("Heartbroken.png");
/*    */   
...
/* 37 */     AbstractDungeon.actionManager.addToBottom((AbstractGameAction)new ApplyPowerAction((AbstractCreature)p, (AbstractCreature)p, (AbstractPower)new HeartbrokenPower((AbstractCreature)p, this.magicNumber), this.magicNumber));
/*    */   }
/*    */ 
/*    */   
/*    */   public void upgrade() {
...
/* Location:              /home/voxelle/Desktop/Koishi.jar!/Koishi/cards/Powers/Rare/Heartbroken.class

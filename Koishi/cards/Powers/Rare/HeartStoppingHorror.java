...
/* 16 */   public static final String ID = KoishiMod.makeID(HeartStoppingHorror.class.getSimpleName());
/* 17 */   public static final String IMG = KoishiMod.makeCardPath("HeartStoppingHorror.png");
/*    */   
...
/* 37 */     KoishiMod.runAnimation("occultAttack");
/* 38 */     AbstractDungeon.actionManager.addToBottom((AbstractGameAction)new ApplyPowerAction((AbstractCreature)p, (AbstractCreature)p, (AbstractPower)new HeartStoppingHorrorPower((AbstractCreature)p, this.magicNumber), this.magicNumber));
/*    */   }
/*    */ 
/*    */ 
/*    */   
...
/* Location:              /home/voxelle/Desktop/Koishi.jar!/Koishi/cards/Powers/Rare/HeartStoppingHorror.class
